...
'''登录'''
def login_shanghu(driver,url,username,password)
    driver.get(url)
    time,sleep(2)
    name = driver.findXpath('/html/body/div/div/form/div[1]/div/div[1]/input')
    pwd = driver.findXpath('/html/body/div/div/form/div[2]/div/div[1]/input')
    login_btn = driver.findXpath('/html/body/div/div/form/div[3]')
