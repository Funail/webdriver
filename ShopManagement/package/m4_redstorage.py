...
def creat_redstorage(driver,dictory6):
    ...
    time.sleep(1)
    driver.find_element_by_css_selector("body > div:nth-child(8) > div.el-picker-panel__body-wrapper > div > div.el-picker-panel__content > table.el-date-table > tbody > tr > td.available.today.current").click()
